...
def dict_creator(first, second):
    if len(first) > len(second):
        second.extend([None] * (len(first) - len(second)))
    return {k: w for k, w in zip(first, second)}


print(dict_creator([3, 4, 5, 6], [44, 66, 56]))
print(dict_creator([3, 4, 5, 6], [44, 66, 56, 77, 88, 89]))
